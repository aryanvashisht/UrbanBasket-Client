...
const SignUp = (e) => {
    ...
    const handleSingUp = async (e) => {
        ...
        const fullName = e.target.name.value //coder1
        const email = e.target.email.value//fds@fj.com
        const password = e.target.password.value //kfdnsfjld
    ...
    return (
        <div className="flex flex-col font-poppins items-center justify-center dark:bg-gray-900 w-full min-h-full">
            <img
                className='w-[7%] cursor-pointer'
                onClick={() => navigate("/")}
                src="LogoForUrbanBasket.png" alt="UrbanBasket" />
            <h1 className='text-[37px]'>
                Welcome to UrbanBasket!
            </h1>
            <div className="grid gap-8">
                ...
                >
                    ...
                    >
                        <h1 className="pt-0 pb-6 font-bold text-5xl dark:text-gray-400 text-center cursor-default">
                            SignUp
                        </h1>
                        <form onSubmit={handleSingUp} className="space-y-4">
                            ...
                            <div className='flex justify-center gap-4'>
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-2xl shadow-md font-semibold transition 
                        ...
                        >
                            ...
                            >
                                <img
                                    ...
                                    alt="Google"
                                />
                                <p>SignUp using Google Account</p>
                            </button>
                            {/* <button
                                href="#"
